...
public class Constants {
    ...
    public static final Font JetBrainsMono =  Font.loadFont(Objects.requireNonNull(Constants.class.getClassLoader().getResource("fonts/EditorFont.ttf")).toExternalForm(), 20);
}